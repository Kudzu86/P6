document.addEventListener('DOMContentLoaded', () => {
    ...
    window.handleImageError = function(imgElement, imgUrl) {
        ...
        imgElement.src = 'https://ih1.redbubble.net/image.3243769575.1059/st,small,507x507-pad,600x600,f8f8f8.jpg'; // URL de secours
    }
                ...
                Promise.all(data.results.map(film => fetchFilmDetails(film.url)))
                    .then(filmsDetails => {
                        filmsDetails.forEach((film, index) => {
                            ...
                            const imgUrl = film.image_url || 'https://ih1.redbubble.net/image.3243769575.1059/st,small,507x507-pad,600x600,f8f8f8.jpg';

                            filmElement.innerHTML = `
                                <div class="film-banner-container">
                                    <a href="${imgUrl}" target="_blank">
                                        <img src="${imgUrl}" alt="Image du film" title="Image du film" 
